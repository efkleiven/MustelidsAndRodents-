...
# give initial values
inits=function(){list( 
  z = sp_inits, alphaA0=runif(2,0.1,0.9), alphaB0=runif(2,0.1,0.9),alphaA1=runif(2,0.1,0.9), alphaB1=runif(2,0.1,0.9),
...
va_mustela_lemming_mod10 <- jags(data, inits=inits, params, "mod10.txt", n.chains = nc,
                                   n.thin = nt, n.iter = ni, n.burnin = nb, n.adapt=na, parallel = T)

# Save model
setwd("./model_output")
save(va_mustela_lemming_habseas, file="va_mustela_lemming_mod10.rda")
